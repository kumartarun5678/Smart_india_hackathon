        ...
        <div className="con">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input type="password" className="form-control" id="password" name="password" onChange={onchange} minLength={5} placeholder='Enter Pass min length 5' required />
                </div>
                <div className="mb-3">
                    <label htmlFor="cpassword" className="form-label">Confirm Password</label>
                    <input type="password" className="form-control" id="cpassword" name="cpassword" onChange={onchange} minLength={5} required placeholder='Enter Pass min length 5' />
                </div>
